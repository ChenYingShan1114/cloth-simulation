...
int main(int argc, char **argv) {
    ...
    Visualize::viewer().launch_init(true,false,"Cloth Simulation Using the Linearly Implicit Euler Method",2560,1280);
    // Visualize::viewer().launch_init(true,false,"Cloth Simulation Using Fully Implicit Newton Method",2560,1280);
    // Visualize::viewer().launch_init(true,false,"Cloth Simulation Using Fully Implicit with Gradient Descent",2560,1280);
